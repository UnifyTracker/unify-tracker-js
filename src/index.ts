...
import { UniTrackerConfig, UniTrackerAPI, TrackProperties, PageChangeCallback } from "./types";
...
const uniTracker: UniTrackerAPI = {
  ...
  pageview: (path?: string) => {
    if (!isInitialized) {
      logError("UnifyTracker SDK not initialized. Call uniTracker.init() first.");
      return;
    }
